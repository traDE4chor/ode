...
public class RestExtensionActivitiesTest extends BPELTestAbstract {
    ...
    /**
     * Tests the "POST" REST extension activity with a static wrapped request message.
     * 
     * @throws Throwable
     */
    @Test
    ...
    public void testPostExtActWithWrongURL() throws Throwable {
        ...
        Invocation inv = addInvoke("REST-POST#1",
                new QName("http://ode/bpel/unit-test.wsdl", "HelloService"), "hello",
    ...
    private void handleHttpRequest(HttpExchange exchange) throws IOException {
        ...
        if (method.toUpperCase().equals("GET")) {
            String response =
                    "<service:getResponse xmlns:service=\"http://www.example.org/restApi\">\n"
            ...
            if (exchange.getRequestURI().getPath().endsWith("/test")) {
                String response =
                        "<service:deleteResponse xmlns:service=\"http://www.example.org/restApi\">\n"
