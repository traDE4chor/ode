...
public class NotifierServiceParameterArray extends ArrayList<NotifierServiceParameter> implements Serializable {
  ...
  public String toString() {
    ...
    sb.append("class NotifierServiceParameterArray {\n");
